...
<html lang="ar" dir="rtl">
  ...
  <!---header--->
    ...
    <!---Response Message--->
        ...
        <div class="message">
          <h2>"Thank for Your Orders"</h2>
          <p>.Thank you for your order<br>.We are so grateful for the pleasure of serving you and hope we meet your expection<br>.!Enjoy the foods<br>.If there is anything else you need, feel free to contact us</p> 
        </div>
